let song = [
    {
        ...
        name: "Peele Peele",
        audio: '/JAVASCRIPT/Spotify Clone/songs/Peele Peele.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/1.jpg",
        name: "Warriyo - Mortals",
        audio: '/JAVASCRIPT/Spotify Clone/songs/1.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/2.jpg",
        name: "Cielo - Huma-Huma",
        audio: '/JAVASCRIPT/Spotify Clone/songs/2.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/3.jpg",
        name: "DEAF KEV",
        audio: '/JAVASCRIPT/Spotify Clone/songs/3.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/4.jpg",
        name: "Different Heaven",
        audio: '/JAVASCRIPT/Spotify Clone/songs/4.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/5.jpg",
        name: "Janji-Heroes-Tonight-feat-Johnning-NCS-Release",
        audio: '/JAVASCRIPT/Spotify Clone/songs/5.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/6.jpg",
        name: "Rabba - Salam-e-Ishq",
        audio: '/JAVASCRIPT/Spotify Clone/songs/6.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/7.jpg",
        name: "Sakhiyaan - Salam-e-Ishq",
        audio: '/JAVASCRIPT/Spotify Clone/songs/7.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/8.jpg",
        name: "Bhula Dena - Salam-e-Ishq",
        audio: '/JAVASCRIPT/Spotify Clone/songs/8.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/9.jpg",
        name: "Tumhari Kasam - Salam-e-Ishq",
        audio: '/JAVASCRIPT/Spotify Clone/songs/9.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
    {
        image: "./covers/10.jpg",
        name: "Na Jaana - Salam-e-Ishq",
        audio: '/JAVASCRIPT/Spotify Clone/songs/10.mp3',
        icon: `<i class="fa-solid fa-play"></i>`
    },
